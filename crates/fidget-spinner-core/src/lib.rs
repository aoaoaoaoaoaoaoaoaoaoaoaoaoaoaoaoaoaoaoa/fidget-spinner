...
pub use crate::model::{
    ...
    FrontierRecord, FrontierStatus, FrontierVerdict, GitCommitHash, HiddenByDefaultReason,
    HypothesisAssessmentLevel, HypothesisAttention, HypothesisLifecycle, HypothesisRecord,
    KnownMetricUnit, KpiOrdinal, KpiReferenceOrdinal, KpiReferenceRecord, MetricAggregation,
